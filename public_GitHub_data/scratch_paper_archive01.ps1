<#
2026-01-03 Sat. 9:33p.
This is just a scratch paper file for storing all the miscellaneous PowerShell
GUI code snippets that I collect over time from the scratch paper file.
#>
