...
My extra notes:
Caution - this script currently doesn't provide an undo function!
...
$folderPath = "C:\temp"
$patternToReplace = "bbbccc"
$replacementText = ""

Get-ChildItem -Path $folderPath -Directory | ForEach-Object {
    $oldFolderName = $_.Name
    $newFolderName = $oldFolderName -replace $patternToReplace, $replacementText
    Rename-Item -Path $_.FullName -NewName $newFolderName -ErrorAction SilentlyContinue
    Write-Host "Renamed folder: $oldFolderName to $newFolderName"
}
